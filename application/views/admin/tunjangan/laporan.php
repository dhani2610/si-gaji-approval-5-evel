...
<div class="row">
	<div class="col-md-12">
			<div class="card">
				...
				<!-- card body -->
				<div class="card-body">
					<form method="GET" action="<?= base_url('admin/tunjangan/laporan') ?>">
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label>Bulan-Tahun</label>
									<input type="month" class="form-control" name="periode" value="<?= $this->input->get('periode') ?>">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control" name="status">
										...
										<option value="1" <?= $this->input->get('status') == '1' ? 'selected' : '' ?>>Not Yet Approve</option>
										<option value="2" <?= $this->input->get('status') == '2' ? 'selected' : '' ?>>Waiting Verification</option>
										<option value="3" <?= $this->input->get('status') == '3' ? 'selected' : '' ?>>Reject</option>
										<option value="4" <?= $this->input->get('status') == '4' ? 'selected' : '' ?>>Approved</option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control" name="verifikator">
										...
										<option value="1" <?= $this->input->get('verifikator') == '1' ? 'selected' : '' ?>>Verifikator 1</option>
										<option value="2" <?= $this->input->get('verifikator') == '2' ? 'selected' : '' ?>>Verifikator 2</option>
										<option value="3" <?= $this->input->get('verifikator') == '3' ? 'selected' : '' ?>>Verifikator 3</option>
										<option value="4" <?= $this->input->get('verifikator') == '4' ? 'selected' : '' ?>>Verifikator 4</option>
										<option value="5" <?= $this->input->get('verifikator') == '5' ? 'selected' : '' ?>>Verifikator 5</option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header with-border">
				<h3 class="card-title">Laporan Data Periode Gaji</h3>
				<!-- button add -->
